            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" id="nama" maxlength="20" value="<?= $mahasiswa['nama'] ?>">
                    ...
                    <a href="../" class="btn btn-warning float-left" onclick="confirm('Ingin keluar');">< Kembali</a>
